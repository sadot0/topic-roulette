...
export const en: Dict = {
  brand: 'Topic Roulette',
  tagline: 'one topic · research · one minute on camera',

  spin: 'Spin',
  spinAgain: 'Next one',
  skipSpin: 'Skip',

  idleLead: 'Press it and get a topic you know nothing about',
  anyTopic: 'Any topic',
  modeQuick: 'Off the cuff',
  modeDeep: 'Deep research',
  modeBuild: 'Vibe coding',
  noteBuild: 'Got a brief — build it',
  phaseBuild: 'building',
  statusBuild: 'build',
  buildDone: 'shipped',
  build: 'Brief',
  toBuild: 'Start building',
  buildLabel: 'Build time',
  noteQuick: 'Speak now, unprepared',
  noteDeep: 'Dig in first, then talk',

  stReady: 'standby',
  stSpin: 'drawing',
  stLocked: 'topic locked',
  ...
  min: 'min',
  settings: 'Settings',
  settingsNote: 'durations in minutes',
  done: 'Done',
